...
Роль	Возможности
Клиент	Создание заявок, просмотр своих заявок, удаление новых заявок, оставление отзывов, добавление адвокатов в избранное
...
POST	/api/lawyers/{id}/add_to_favorites/	Добавить в избранное	Клиент
DELETE	/api/lawyers/{id}/remove_from_favorites/	Удалить из избранного	Клиент
GET	/api/lawyers/my_favorites/	Список избранного	Клиент
...
Основные коммиты	feat: initial commit, docs: final README, feat: add favorites system
👨‍💻 Автор
Студент группы ПИЖ-б-о-24-1
Красненькин Роман Александрович
Направление подготовки: 09.03.04 «Программная инженерия»
Профиль: «Разработка и сопровождение программного обеспечения»

🔗 Ссылки
GitHub репозиторий: https://github.com/Justake206/lexexpect-course

Документация API (локально): http://127.0.0.1:8000/api/services/
